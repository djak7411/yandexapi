...
public class DeleteItemFragment extends IODialogFragment {
    ...
    private static final String DELETE_PATH = "delete.path";
    private static final String DELETE_DISPLAY_NAME = "delete.display.name";
    private static final String DELETE_IS_COLLECTION = "delete.is.collection";
    ...
    public void onComplete() {
        ...
        ((YaApiActivity) getActivity()).reloadContent();
    }
